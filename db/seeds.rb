...
associations = [
    {name: "ADMR", photo: "https://www.bainssuroust.fr/medias/2020/03/ADMR_baseline_JPG-scaled.jpg", city: "Paris", description: "Service d'aide à la personne", tag: ["Aide à domicile", "Soin", "Service"]},
    ...
    {name: "Fondation Abbé Pierre", photo: "https://infodon.fr/wp-content/uploads/2019/09/FAP.png", city: "Paris", description: "La Fondation Abbé Pierre agit contre le mal-logement et l'exclusion aux côtés des plus démunis.", tag: ["Lien social", "Entraide", "Hébergement"]},
    {name: "Médecins Sans Frontières", photo: "https://upload.wikimedia.org/wikipedia/fr/thumb/6/69/MSF.svg/1200px-MSF.svg.png", city: "Paris", description: "MSF apporte une assistance médicale aux populations menacées, en France ou à l’étranger.", tag: ["Soin", "Maladie", "Nutrition"]},
    {name: "Handicap International", photo: "https://infodon.fr/wp-content/uploads/2019/09/HI.png", city: "Paris", description: "Handicap International vient en aide aux populations vulnérables, notamment les personnes handicapées, partout dans le monde où cela est nécessaire.", tag: ["Lien social", "Mobilité", "Maladie"]},
    {name: "Unicef", photo: "https://jamaity.org/wp-content/uploads/2014/05/logo_ptf_unicef.jpg", city: "Paris", description: "UNICEF travaille dans les endroits les plus inhospitaliers du monde pour atteindre les enfants et les adolescents les plus défavorisés.", tag: ["Soin", "Hébergement", "Droit"]},
    {name: "Armée du Salut", photo: "https://www.francebenevolat.org/sites/default/files/relais/ArmeeduSalut_TEST400x210.jpg", city: "Paris", description: "Pour lutter contre l'exclusion sociale et faciliter l'insertion sociale et professionnelle", tag: ["Hébergement", "Insertion", "Lien social"]},
    {name: "Entraides Citoyennes", photo: "https://entraides-citoyennes.org/wp-content/uploads/2020/11/Logoo.png", city: "Paris", description: "Entraides Citoyennes est une association loi 1901 qui vient en aide aux sans-abris.", tag: ["Hébergement", "Soin", "Paniers"]},
    {name: "Refettorio", photo: "https://refettorioparis.com/images/logo_big@2x.png", city: "Paris", description: "Le Refettorio Paris est un restaurant solidaire situé dans la crypte de l'église de la Madeleine, au coeur de Paris.", tag: ["Paniers", "Entraide"]},
    {name: "Petits Princes", photo: "https://infodon.fr/wp-content/uploads/2019/09/Association-Petits-princes.jpg", city: "Paris", description: "L'Association Petits Princes, créée en 1987, réalise les rêves des enfants et des adolescents gravement malades.", tag: ["Soin", "Maladie", "Mobilité"]},
    {name: "Collectif Solidaire", photo: "https://www.rungisinternational.com/wp-content/uploads/2020/04/IMG_0442-532x520.jpg" , city: "Paris", description: "L'association Collectif Solidaire est un collectif de citoyens et de chefs qui viennent en aide aux plus démunis en leur apportant des soutiens alimentaires", tag: ["Dons", "Entraide"]},
    {name: "Nous toutes", photo: "https://www.noustoutes.org/wp-content/uploads/2020/09/Blanc-sur-violet.png", city: "Paris", description: "Le collectif #NousToutes est un collectif féministe engagé contre les violences sexistes, sexuelles, économiques, psychologiques, verbales et physiques faites aux femmes.", tag: ["Femme", "Sexuel", "Moral"]},
    {name: "Women Safe", photo: "https://www.lavilladescreateurs.com/wp-content/uploads/2020/02/unnamed1-e1581603075607.png", city: "Paris", description: "Prise en charge pluridisciplinaire des violences - Accompagnement global des femmes et enfants victimes de violences", tag: ["Femme", "Psychologie", "Conjugal", "Enfant"]},
    {name: "La Maison Des Femmes", photo: "https://pbs.twimg.com/profile_images/771718914875265024/cU42cDRT_400x400.jpg", city: "Paris", description: "Une maison, pour accueillir toutes les femmes vulnérables ou victimes de violence.", tag: ["Femme", "Vulnérabilité", "Conjugal"]},
    ...
    {name: "Planning Familial", photo: "https://www.madmoizelle.com/wp-content/uploads/2015/12/planning-familial-utilite-temoignages.jpg", city: "Paris", description: "Le planning familial est un mouvement féministe et d’éducation populaire, le Planning Familial milite pour le droit à l’éducation à la sexualité, à la contraception, à l’avortement, à l’égalité.", tag: ["Femme", "Soin", "Lien social"]},
    ...
    {name: "Papillons Blanc de Paris", photo: "https://www.tousbenevoles.org/images/association/1418313974.png", city: "Paris", description: "Les papillons blanc de paris accompagne les personnes atteintes d’un handicap mental et leur famille.", tag: ["Soin", "Maladie", "Lien social", "Mobilité"]},
    ...
    {name: "Secours Catholique", photo: "https://www.tousbenevoles.org/images/action/image-156.jpg", city: "Paris", description: "Le Secours catholique est attentif aux problèmes de pauvreté et d’exclusion de tous les publics et cherche à promouvoir la justice sociale.", tag: ["Droit", "Entraide", "Insertion"]},
    ...
    {name: "Viens voir mon Taf", photo: "https://miro.medium.com/max/1000/1*EDYQmYWD_6Cx82rUaTkghA.png", city: "Paris", description: "Viens voir mon Taf permet aux collégiens sans réseau de l’éducation prioritaire de faire des stages de troisième motivants, de qualité, et pertinents pour leur orientation !", tag: ["Insertion", "Offre", "Lien social"]},
    {name: "TANDEM réfugiés", photo: "https://storage.benevolt.fr/55ca0690-1f50-48c9-bd5e-3bf986aaf3a0/c/logo-tandem-rouge-carre-avatar.jpg", city: "Paris", description: "Tandem Réfugiés est né à l’initiative de deux parisiennes, l’association accompagne des personnes réfugiées dans leur insertion en France.", tag: ["Insertion", "Offre", "Lien social", "Droit"]},
    ...
    {name: "Les auxiliaires des aveugles", photo: "https://pimcore.france-media.net/var/assets/images/aa_photo.png", city: "Paris", description: "Les auxiliaires des aveugles est une association qui met en lien des personnes aveugles ou malvoyantes avec des bénévoles pour les aider dans leur quotidien.", tag: ["Soin", "Maladie", "Mobilité"]},
    {name: "Le silence des justes", photo: "https://lesilencedesjustes.fr/wp-content/uploads/2019/05/La-Boutique-des-justes-2.jpg", city: "Paris", description: "Le silence des justes accompagne les jeunes avec autisme et trouble apparentés, ainsi que leurs familles, depuis la prise en charge précoce jusqu’à leur devenir.", tag: ["Soin", "Maladie", "Lien social"]}
]
