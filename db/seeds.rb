...
associations = [
    ...
    {name: "Je t'aide", photo: "https://associationjetaide.org/wp-content/uploads/2020/07/logo-jetaide-scaled.jpg", city: "Paris", description: "Luttons contre l'isolement social des aidant.es !", tag: ["Service", ]},
