...
associations = [
    ...
    {name: "Assedea", photo: "https://annuaire-association.com/uploads/images_thumbs/08/08f56a8e.png", address:"5 bis, rue du Louvre", city: "Paris", description:"L'association Assédea regroupe des bénévoles qui œuvrent dans le but d'aider les familles ayant des enfants qui ont une malformation depuis la naissance.", tag: ["Aide à domicile", "Soin", "Mobilité"]},
