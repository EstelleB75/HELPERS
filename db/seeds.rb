...
associations = [
    ...
    {name: "Handicap International", photo: "https://infodon.fr/wp-content/uploads/2019/09/HI.png", city: "Paris", description: "Handicap International vient en aide aux populations vulnérables, notamment les personnes handicapées, partout dans le monde où cela est nécessaire.", tag: ["Lien social", "Mobilité", "Soin"]},
    ...
    {name: "Entraides Citoyennes", photo: "https://entraides-citoyennes.org/wp-content/uploads/2020/11/Logoo.png", city: "Paris", description: "Entraides Citoyennes est une association loi 1901 qui vient en aide aux sans-abris.", tag: [""]},
